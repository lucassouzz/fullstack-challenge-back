    ...
    try {
        ...
        const user = await prisma.user.create({
            data: {
                ...
                password //shorthand usando quando a variavel tem a mesma declaração do atributo (o mesmo que password: password)
            }
        })
        ...
        if (err.meta && !err.meta.target) {
            ctx.status = 422
            ctx.body = "Email ou nome do usuário já cadastrado!"
            return
        }
